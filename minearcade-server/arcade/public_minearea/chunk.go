...
func (c *Chunk) ConvertToPacket() packet_arcade.PublicMineAreaChunk {
	return packet_arcade.PublicMineAreaChunk{ChunkX: int32(c.ChunkX), ChunkY: int32(c.ChunkY), ChunkData: c.ChunkData}
}
